...
public class UserOperateController  extends  BaseController{
    ...
    public RestResult addUser(@RequestBody UserInfo userInfo) {
        RestResult pre = preCheck("addUser",UserOperateController.class);
        if(null != pre){
    ...
    public RestResult deleteUserById(Integer userId) {
        RestResult pre = preCheck("deleteUserById",UserOperateController.class);
        if(null != pre){
            System.out.print("提前判断权限，权限失败");
            return pre;
        }else {
    ...
    public RestResult updateUserInfo(@RequestBody UserInfo userInfo) {
        RestResult pre = preCheck("updateUserInfo",UserOperateController.class);
        if(null != pre){
            System.out.print("提前判断权限，权限失败");
            return pre;
        }else {
