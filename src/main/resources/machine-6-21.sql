...
CREATE TABLE `t_orders`  (
  ...
  `store_id` int(11) NOT NULL DEFAULT -1 COMMENT 'store id',
...
-- ----------------------------
INSERT INTO `user_info` VALUES (7, 'guoxi', 'guoxi_789@126.com', '18640883727', 'beijing', '$2a$10$7XHoUDOhHao5KNBw6a6h9.OAugCAZEvXFbO9S/jqINfPn4.eZvq3C', 'admin', 'admin', 'xx科技有限公司');
INSERT INTO `user_info` VALUES (8, 'ytuo', 'guoxi_789@126.com', '18640883727', 'shanghai', '$2a$10$ZhJ1jpbnwKPgV1tz7yil1.fwQyoPeoVNQ3sK2wkJbArhiVi3OcPDa', 'admin', 'admin', 'tt科技有限公司');
